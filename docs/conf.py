...
# -*- coding: utf-8 -*-
#
# aionet documentation build configuration file, created by
...
latex_documents = [(master_doc, 'aionet.tex', 'aionet Documentation', 'Yakovlev Sergey', 'manual'), ]
...
man_pages = [(master_doc, 'aionet', 'aionet Documentation', [author], 1)]
...
texinfo_documents = [(
master_doc, 'aionet', 'aionet Documentation', author, 'aionet', 'One line description of project.', 'Miscellaneous'), ]
